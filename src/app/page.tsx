...
var navLinkClass = 'text-xs font-chakra drop-shadow-lg lg:font-medium bg-blur text-slate-100 drop-shadow-sm hover:scale-[1.2] transition-all'
const staffMembers = [
  {
    'name': 'Ayden Springer',
    'nickname': 'Kryptic',
    ...
    <main className="flex min-h-screen grow w-full lg:w-[95vw] border border-t-0 border-b-0 border-sky-500/50 mx-auto flex-col items-center justify-between">
      <section className="relative z-50 border-b border-sky-500/50 flex flex-col h-[80vh] w-full bg-zinc-900/10">
        ...
        <div className="absolute top-0 w-full h-full">
          <nav className="sticky backdrop-blur-sm z-40 max-w-fit inset-x-0 mx-auto max-h-12 shadow-md shadow-slate-950/40 bg-gradient-to-r from-white/[.02] via-white/[0.3] to-white/[.02] bg-blur flex space-x-4 px-6 items-center justify-between top-14 my-14">
        ...
        <div className="w-full h-48 lg:h-80 select-none border-b border-sky-500/50 flex flex-row justify-center flex-wrap">
          <div className="relative w-full overflow-hidden flex justify-center items-center">
            ...
            <div className="flex flex-col justify-center items-center">
              <h1 className="font-chakra h-4 text-xs lg:text-lg font-bold text-sky-400 uppercase">Where Legends are Born</h1>
              <p className="font-chakra mt-2 h-4 text-xs lg:text-sm font-light text-white uppercase">Meet the Teams</p>
              <a href="#Rosters" className="z-20 transition-all duration-500 flex flex-row justify-center items-center text-black bg-sky-500 hover:bg-sky-600 font-chakra font-medium px-6 py-2 my-2 lg:text-2xl">Rosters <ArrowUpRightIcon className="w-6 p-1 stroke-black" /> </a>
            </div>
          </div>
        </div>
